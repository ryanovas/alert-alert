...
$(document).ready(function(){function e(e,t,n){if(n){var r=new Date;r.setTime(r.getTime()+n*24*60*60*1e3);var i="; expires="+r.toGMTString()}else var i="";document.cookie=e+"="+t+i+"; path=/"}function t(e){var t=e+"=";var n=document.cookie.split(";");for(var r=0;r<n.length;r++){var i=n[r];while(i.charAt(0)==" ")i=i.substring(1,i.length);if(i.indexOf(t)==0)return i.substring(t.length,i.length)}return null}if(t("alertTimer")===null){alert("Please note this is just a prototype, we are currently developing a fully functional product.");e("alertTimer",true,.076)}$("#filterButton").click(function(){$("#filterModal").css({opacity:"1",zIndex:"9999",pointerEvents:"auto"});$("#modalCover").css("display","block")});$("#filterCancel").click(function(){$("#filterModal").css({opacity:"0",zIndex:"-9999",pointerEvents:"none"});$("#modalCover").css("display","none")});$("#filterOK").click(function(){$("#filterModal").css({opacity:"0",zIndex:"-9999",pointerEvents:"none"});$("#modalCover").css("display","none")});$("#subButton").click(function(){$("#subscribeModal").css({opacity:"1",zIndex:"9999",pointerEvents:"auto"});$("#modalCover").css("display","block")});$("#subCancel").click(function(){$("#subscribeModal").css({opacity:"0",zIndex:"-9999",pointerEvents:"none"});$("#modalCover").css("display","none")});$("#subOK").click(function(){$("#subscribeModal").css({opacity:"0",zIndex:"-9999",pointerEvents:"none"});$("#modalCover").css("display","none")});jQuery.urlShortener.settings.apiKey="AIzaSyB5G9uHkh_xMaazDUV2loBWUpnuROvEiHA";jQuery.urlShortener({longUrl:window.location.href,success:function(e){var t='Check out the "Best Use of Data" winner of #SpaceApps2014 @SkyWatchApps! #space #astronomy #bigdata';$(".share").share({url:e,text:t,image:"http://skywatch.co/assets/images/logo.png",button_text:"Share",flyout:"bottom left"})},error:function(e){console.log(JSON.stringify(e))}})})
